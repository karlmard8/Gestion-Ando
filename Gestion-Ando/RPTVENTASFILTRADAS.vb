...
Public Class RPTVENTASFILTRADAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gestion_Ando.RPTVENTASFILTRADAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTVENTASFILTRADAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTVENTASFILTRADAS = New RPTVENTASFILTRADAS()
        rpt.Site = Me.Site
        Return rpt
    End Function
