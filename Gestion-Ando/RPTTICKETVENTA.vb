...
Public Class RPTTICKETVENTA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gestion_Ando.RPTTICKETVENTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_VENID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPTTICKETVENTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTTICKETVENTA = New RPTTICKETVENTA()
        rpt.Site = Me.Site
        Return rpt
    End Function
