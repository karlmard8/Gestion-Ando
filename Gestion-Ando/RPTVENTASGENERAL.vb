...
Public Class RPTVENTASGENERAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gestion_Ando.RPTVENTASGENERAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTVENTASGENERAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTVENTASGENERAL = New RPTVENTASGENERAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
